...
class Perlin {
    static Init() {
        this.grad3 = [new Grad_1.Grad(1, 1, 0), new Grad_1.Grad(-1, 1, 0), new Grad_1.Grad(1, -1, 0), new Grad_1.Grad(-1, -1, 0),
            new Grad_1.Grad(1, 0, 1), new Grad_1.Grad(-1, 0, 1), new Grad_1.Grad(1, 0, -1), new Grad_1.Grad(-1, 0, -1),
            new Grad_1.Grad(0, 1, 1), new Grad_1.Grad(0, -1, 1), new Grad_1.Grad(0, 1, -1), new Grad_1.Grad(0, -1, -1)];
    ...
    static perlin2(x, y) {
        ...
        let xrel = Math.floor(x), yrel = Math.floor(y);
        ...
        console.log(yrel);
        var n00 = this.gradP[xrel + this.perm[yrel]].dot2(x, y);
        var n01 = this.gradP[xrel + this.perm[yrel + 1]].dot2(x, y - 1);
        var n10 = this.gradP[xrel + 1 + this.perm[yrel]].dot2(x - 1, y);
        var n11 = this.gradP[xrel + 1 + this.perm[yrel + 1]].dot2(x - 1, y - 1);
